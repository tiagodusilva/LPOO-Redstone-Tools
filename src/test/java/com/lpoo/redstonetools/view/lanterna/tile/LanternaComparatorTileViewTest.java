...
public class LanternaComparatorTileViewTest {
    @Test
    @Tag("view")
    @Tag("unit-test") @Tag("fast")
    public void testRender() {
        LanternaComparatorTileView view = Mockito.mock(LanternaComparatorTileView.class);
        ...
        ComparatorTile tile = Mockito.mock(ComparatorTile.class);
        ...
        Mockito.verify(view, Mockito.times(1))
                .renderPowerSensitiveFrame(graphics, tile, -5, -3);
        ...
        Mockito.verify(graphics, Mockito.times(1))
                .setCharacter(Mockito.eq(-4), Mockito.eq(-2), Mockito.anyChar());

        view.render(tile, 0, 3, graphics);

        Mockito.verify(view, Mockito.times(1))
                .renderPowerSensitiveFrame(graphics, tile, 3, 0);
