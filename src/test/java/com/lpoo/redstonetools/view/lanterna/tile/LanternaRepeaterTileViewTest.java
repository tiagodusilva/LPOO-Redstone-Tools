...
public class LanternaRepeaterTileViewTest {

    @Test
    @Tag("view")
    @Tag("unit-test") @Tag("fast")
    public void testRender() {
        LanternaRepeaterTileView view = Mockito.mock(LanternaRepeaterTileView.class);
        ...
        RepeaterTile tile = Mockito.mock(RepeaterTile.class);
